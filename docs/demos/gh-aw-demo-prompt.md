...
- Live demo using the [gh-aw-shared-workflows](https://github.com/RealPage/gh-aw-shared-workflows) repo
...
**Setup**: Have the lumina-agents-mcp repo open. Show its `.github/workflows/` directory with the workflow stubs that import from gh-aw-shared-workflows.
...
- Show the workflow stubs — "Each of these is 10-15 lines. The shared logic lives in gh-aw-shared-workflows and gets imported."
...
- Open `workflows/auto-remediation.md` from gh-aw-shared-workflows and walk through the 5 stages:
...
- Share resources: gh-aw docs, gh-aw-shared-workflows repo, agentic-workflow-template repo, Agent Factory blog series
...
- [ ] gh-aw-shared-workflows repo is up to date
...
- [ ] Browser tabs pre-loaded: gh-aw docs site, gh-aw blog, gh-aw-shared-workflows README, lumina-agents-mcp repo
